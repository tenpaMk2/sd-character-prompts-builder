...
const promptRecords = [
  ...
  {
    category: `eyebrows-shape` as const,
  ...
  {
    category: `top-of-the-head` as const,
  ...
  {
    category: `hair-ornament` as const,
