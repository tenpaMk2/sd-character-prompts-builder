...
export const colorCategoryTree: {
  ...
  "eyewear-frame-color": [
    { prompt: `aqua-framed eyewear`, colorName: `aqua` },
    { prompt: `black-framed eyewear`, colorName: `black` },
    { prompt: `blue-framed eyewear`, colorName: `blue` },
    { prompt: `brown-framed eyewear`, colorName: `brown` },
    { prompt: `green-framed eyewear`, colorName: `green` },
    { prompt: `grey-framed eyewear`, colorName: `grey` },
    { prompt: `orange-framed eyewear`, colorName: `orange` },
    { prompt: `pink-framed eyewear`, colorName: `pink` },
    { prompt: `purple-framed eyewear`, colorName: `purple` },
    { prompt: `red-framed eyewear`, colorName: `red` },
    { prompt: `white-framed eyewear`, colorName: `white` },
    { prompt: `yellow-framed eyewear`, colorName: `yellow` },
  ],
  "glasses-tinted-color": [
    { prompt: `blue-tinted eyewear`, colorName: `blue` },
    { prompt: `green-tinted eyewear`, colorName: `green` },
    { prompt: `orange-tinted eyewear`, colorName: `orange` },
    { prompt: `pink-tinted eyewear`, colorName: `pink` },
    { prompt: `purple-tinted eyewear`, colorName: `purple` },
    { prompt: `red-tinted eyewear`, colorName: `red` },
    { prompt: `yellow-tinted eyewear`, colorName: `yellow` },
  ],
  "hair-color": [
  ...
  eyewear: [
    {
      ...
      prompt: `glasses`,
      children: [
        { type: `color-parent`, colorCategory: `eyewear-frame-color` },
        {
          type: `parent-prompt`,
          prompt: `tinted eyewear`,
          children: [
            { type: `color-parent`, colorCategory: `glasses-tinted-color` },
          ],
        },
        { type: `child-prompt`, prompt: `heart-shaped eyewear` },
        { type: `child-prompt`, prompt: `star-shaped eyewear` },
        { type: `child-prompt`, prompt: `teardrop-framed glasses` },
        { type: `child-prompt`, prompt: `rectangular eyewear` },
        { type: `child-prompt`, prompt: `round eyewear` },
        { type: `child-prompt`, prompt: `rimless eyewear` },
        {
          type: `parent-prompt`,
          prompt: `semi-rimless eyewear`,
          children: [
            { type: `child-prompt`, prompt: `over-rim eyewear` },
            { type: `child-prompt`, prompt: `under-rim eyewear` },
          ],
        },
        { type: `child-prompt`, prompt: `coke-bottle glasses` },
        { type: `child-prompt`, prompt: `opaque glasses` },
      ],
    },
    {
      type: `parent-prompt`,
      prompt: `sunglasses`,
      children: [{ type: `child-prompt`, prompt: `aviator sunglasses` }],
    },
    { type: `child-prompt`, prompt: `goggles` },
    { type: `child-prompt`, prompt: `monocle` },
    { type: `child-prompt`, prompt: `eyepatch` },
    { type: `child-prompt`, prompt: `diving mask` },
    { type: `child-prompt`, prompt: `pince-nez` },
    { type: `child-prompt`, prompt: `scouter` },
    { type: `child-prompt`, prompt: `eyewear on head` },
    { type: `child-prompt`, prompt: `eyewear on headwear` },
    { type: `child-prompt`, prompt: `eyewear strap` },
    { type: `child-prompt`, prompt: `no eyewear` },
    { type: `child-prompt`, prompt: `bespectacled` },
  ],
  "hair-color": [
...
for (const category of getKeys(uITree)) {
  ...
  if (isDuplicated(prompts)) {
    throw new Error(`Prompts in \`${category}\` category are duplicated!!`);
  }
}
